...
$(document).ready(function () {
     ...
     */
     ...
     function renderQuestion() {
          ...
          let allAnswersArray = [currentQueAndAns[pos].correct_answer, currentQueAndAns[pos].incorrect_answers[0], currentQueAndAns[pos].incorrect_answers[1], currentQueAndAns[pos].incorrect_answers[2]];
